...
A [show](/getting-started/concepts#shows) is your podcast series in Henshu. It is the top-level container that holds all your episodes. Before you can create episodes, you need at least one show.
