...
sidebarTitle: "Generate Show Notes"
...
<Frame>
  <img src="/images/export.png" alt="Henshu editor showing sections with audio blocks and pause blocks, each annotated" />
</Frame>
...
<Frame>
  <img src="/images/show-notes.png" alt="Show notes with summary, highlights, and chapters" style={{ maxWidth: '500px' }} />
</Frame>
...
Chapter timestamps are derived from your transcript's word-level timing. If timestamps seem off, you can edit them by hand to get the exact timing you want.
