...
Background music is assigned per section, not per episode. Your intro can have upbeat music, your interview section can have subtle ambient music, and your outro can have different music entirely. The music library is linked to your show, so tracks you add are available across all episodes in that show.
