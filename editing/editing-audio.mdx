...
<Frame>
  <img src="/images/edit-audio-view.png" alt="Audio block detail view with waveform and transcript" style={{ maxHeight: '500px', border: '1px solid #e5e7eb', borderRadius: '8px' }}/>
</Frame>
...
<Frame>
  <img src="/images/trim-handle.png" alt="Waveform with purple trim handles at the start and end" style={{ maxHeight: '500px', border: '1px solid #e5e7eb', borderRadius: '8px' }}/>
</Frame>
...
<Frame>
  <img src="/images/waveform-cut-mute.png" alt="Waveform with a selected region and Cut/Mute options" style={{ maxHeight: '240px', border: '1px solid #e5e7eb', borderRadius: '8px' }}/>
</Frame>
...
<Frame>
  <img src="/images/text-based-editing.png" alt="Transcript with words selected for cutting" style={{ maxHeight: '240px', border: '1px solid #e5e7eb', borderRadius: '8px' }}/>
</Frame>
