...
Before you start, make sure you've [created a show](/creating/shows), [created an episode](/creating/episodes), and [uploaded your audio](/creating/uploading-audio).
...
## Improve your audio with AI (optional)
